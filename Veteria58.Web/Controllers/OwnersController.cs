...
namespace Veteria58.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "The Owners can't be remove.");
                return RedirectToAction(nameof(Index));
            }
            //elimina el usuario 
        ...
        //eliminar L historia desde el modal
        ...
        public async Task<IActionResult> DeletePet(int? id)
        {
            ...
            if(pet.Histories.Count>0)
                {
                ModelState.AddModelError(string.Empty, "The pet can't be delete because it related records.");
